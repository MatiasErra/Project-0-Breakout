...
function love.load()
    ...
    gFrames = {
        ...
        ['blocked'] = GenerateBlockQuadsBricks(gTextures['main'])
    }
    ...
    gSounds['select']:setVolume(0.01)
    gSounds['no-select']:setVolume(0.01)
    gSounds['brick-hit-1']:setVolume(0.01)
    gSounds['brick-hit-2']:setVolume(0.01)
    gSounds['hurt']:setVolume(0.01)
    gSounds['victory']:setVolume(0.01)
    gSounds['recover']:setVolume(0.01)
    gSounds['high-score']:setVolume(0.01)
    gSounds['pause']:setVolume(0.01)
